...
object Cosets extends lisa.Main:
  ...
  val leftCosetStaysInGroupLemma = Theorem(
    ...
    val goal = have(y ∈ lc |- y ∈ G) subproof {
        ...
        have(op(x, *, h1) ∈ G) by Tautology.from(
            binaryOperationThm of (G := G, * := *, x := x, y := h1),
            group.definition,
  ...
  val rightCosetStaysInGroupLemma = Theorem(
    ...
    val goal = have(y ∈ rc |- y ∈ G) subproof {
      ...
      val substep2 = have(op(h1, *, x) ∈ G) by Tautology.from(
        binaryOperationThm of (G := G, * := *, x := h1, y := x),
        group.definition,
        elementInSubgroupMeansItsInGroup of (x := h1),
        hThm
      )
  ...
  val leftCosetMembershipTest = Theorem(
    (group(G)(*), subgroup(H)(G)(*), h ∈ H, a === op(b, *, h))
      |- a ∈ leftCoset(b)(*)(H)
  ) {
    assume(group(G)(*), subgroup(H)(G)(*), h ∈ H, a === op(b, *, h))

    val lc_def = (op(b, *, h) | (h ∈ H)) === leftCoset(b)(*)(H)
    ...
    val _2 = have(lc_def |- a ∈ leftCoset(b)(*)(H)) by
  ...
  val rightCosetMembershipTest = Theorem(
    (group(G)(*), subgroup(H)(G)(*), h ∈ H, a === op(h, *, b))
      |- a ∈ rightCoset(H)(*)(b)
  ) {
    assume(group(G)(*), subgroup(H)(G)(*), h ∈ H, a === op(h, *, b))

    val rc_def = (op(h, *, b) | (h ∈ H)) === rightCoset(H)(*)(b)
    ...
    val _2 = have(rc_def |- a ∈ rightCoset(H)(*)(b)) by Substitution.Apply(rc_def)(_h)
    have(thesis) by Tautology.from(_1, _2)
  }
  ...
  |- ∃(h ∈ H, a === op(b, *, h))
    ...
    val _h = have(a ∈ leftCoset(b)(*)(H)) by Restate
  ...
  val rightCosetMembership = Theorem(
    ...
    assume(group(G)(*),
      subgroup(H)(G)(*),
      a ∈ rightCoset(H)(*)(b))
    val _h = have(a ∈ rightCoset(H)(*)(b)) by Restate
    val rc_def = (op(h, *, b) | (h ∈ H)) === rightCoset(H)(*)(b)
    val _1 = have(rc_def) by Tautology.from(rightCoset.definition of (g := b))
  ...
  ( group(G)(*),
    ...
    val Ha = leftCoset(a)(*)(H)
    val Hb = leftCoset(b)(*)(H)
  ...
  val rightCosetSubsetFromMembership = Theorem(
    ...
    val Ha = rightCoset(H)(*)(a)
    val Hb = rightCoset(H)(*)(b)
  ...
  (group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G)
    |- (a ∈ leftCoset(b)(*)(H)) <=> (b ∈ leftCoset(a)(*)(H))
  ) {
    assume(group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G)

    val implication = have(a ∈ leftCoset(b)(*)(H) |- b ∈ leftCoset(a)(*)(H)) subproof {
        assume(a ∈ leftCoset(b)(*)(H))
  ...
  val rightCosetMembershipEquivalence = Theorem(
    (group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G) |- (a ∈ rightCoset(H)(*)(b)) <=> (b ∈ rightCoset(H)(*)(a))
  ) {
    assume(group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G)
    
    val implication = have(a ∈ rightCoset(H)(*)(b) |- b ∈ rightCoset(H)(*)(a)) subproof {
        assume(a ∈ rightCoset(H)(*)(b))
        val Ha = rightCoset(H)(*)(a)
        val Hb = rightCoset(H)(*)(b)
  ...
  (group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G, a ∈ leftCoset(b)(*)(H))
    |- leftCoset(a)(*)(H) === leftCoset(b)(*)(H)
  ) {
    assume(group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G, a ∈ leftCoset(b)(*)(H))
  ...
  (group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G, a ∈ rightCoset(H)(*)(b))
    |- rightCoset(H)(*)(a) === rightCoset(H)(*)(b)
  ) {
    assume(group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G, a ∈ rightCoset(H)(*)(b))
  ...
  val cosetContainsRepresentative = Theorem(
    (group(G)(*), subgroup(H)(G)(*), x ∈ G)
    |- x ∈ leftCoset(x)(*)(H) /\ x ∈ rightCoset(H)(*)(x)
  ) {
    val e0 = identityOf(H)(*)
    have(thesis) by Tautology.from(
  ...
  val leftCosetMapsToRightCoset = Theorem(
    (group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G, a ∈ leftCoset(b)(*)(H)) |-
        inverseOf(G)(*)(a) ∈ rightCoset(H)(*)(inverseOf(G)(*)(b))
  ) {
    assume(group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G)
    assume(a ∈ leftCoset(b)(*)(H))
    ...
    val inva = inverseOf(G)(*)(a)
    val invb = inverseOf(G)(*)(b)
    ...
    have(inva ∈ rightCoset(H)(*)(invb)) by Tautology.from(
        _4,
  ...
  (group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G, a ∈ rightCoset(H)(*)(b)) |-
    inverseOf(G)(*)(a) ∈ leftCoset(inverseOf(G)(*)(b))(*)(H)
  ) {
    assume(group(G)(*), subgroup(H)(G)(*), a ∈ G, b ∈ G)
    assume(a ∈ rightCoset(H)(*)(b))
    ...
    have(inva ∈ leftCoset(invb)(*)(H)) by Tautology.from(
        _4,
  ...
  val leftCosetIdentity = Theorem(
    (group(G)(*), subgroup(H)(G)(*), isIdentityElement(G)(*)(e)) |-
    H === leftCoset(e)(*)(H)
  ) {
    assume(group(G)(*), subgroup(H)(G)(*), isIdentityElement(G)(*)(e))
    val dir1 = have(x ∈ leftCoset(e)(*)(H) ==> x ∈ H) subproof {
      assume(x ∈ leftCoset(e)(*)(H))
    ...
    val dir2 = have(x ∈ H ==> x ∈ leftCoset(e)(*)(H)) subproof {
      assume(x ∈ H)
    ...
    have(x ∈ H <=> x ∈ leftCoset(e)(*)(H)) by Tautology.from(dir1,dir2)
    val forallEquiv = thenHave(∀(x, x ∈ H <=> x ∈ leftCoset(e)(*)(H))) by RightForall
    have(thesis) by Tautology.from(
  ...
  val rightCosetIdentity = Theorem(
    ...
    assume(group(G)(*), subgroup(H)(G)(*), isIdentityElement(G)(*)(e))
    val dir1 = have(x ∈ rightCoset(H)(*)(e) ==> x ∈ H) subproof {
      assume(x ∈ rightCoset(H)(*)(e))
    ...
    val dir2 = have(x ∈ H ==> x ∈ rightCoset(H)(*)(e)) subproof {
      assume(x ∈ H)
    ...
    have(x ∈ H <=> x ∈ rightCoset(H)(*)(e)) by Tautology.from(dir1, dir2)
    val forallEquiv = thenHave(∀(x, x ∈ H <=> x ∈ rightCoset(H)(*)(e))) by RightForall
    have(thesis) by Tautology.from(
      extensionalityAxiom of (
        x := H,
        y := rightCoset(H)(*)(e)
